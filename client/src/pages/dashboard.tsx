...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:via-black dark:to-gray-900 py-16 lg:py-24 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-6 transition-colors">
              Interactive Radiology
              <span className="text-orange-500 block">Pattern Recognition</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button 
                ...
                size="lg"
                className="bg-gray-100 hover:bg-gray-200 dark:bg-gray-800/50 dark:hover:bg-gray-700/50 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 hover:border-orange-500 px-8 py-4 text-lg transform hover:scale-105 transition-all duration-200 backdrop-blur-xl"
              >
      ...
      <section id="constellation-viewer" className="py-16 bg-gray-100/50 dark:bg-gray-900/30 backdrop-blur-xl transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 transition-colors">{currentCaseName} - Interactive Learning</h2>
